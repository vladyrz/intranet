...
use App\Filament\Soporte\Resources\SaleResource\Pages;
use App\Filament\Soporte\Resources\SaleResource\RelationManagers;
use App\Models\Sale;
use Filament\Forms;
...
class SaleResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make(__('resources.sales.sectionSale'))
                    ->columns(3)
                    ->schema([
