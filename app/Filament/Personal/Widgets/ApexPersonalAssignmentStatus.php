...
use App\Filament\Personal\Traits\PersonalAssignmentTrait;
use Leandrocfe\FilamentApexCharts\Widgets\ApexChartWidget;

class ApexPersonalAssignmentStatus extends ApexChartWidget
{
    use PersonalAssignmentTrait;
     ...
     * @var string
     */
    protected static string $chartId = 'apexPersonalAssignmentStatus';
